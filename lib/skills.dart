...
import 'package:cv/add_education.dart';
...
class _SkillsState extends State<Skills> {
  ...
  setSkills() async {
    ...
    pref.setString(SKILLS, jsonEncode(selectedData));
  }
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          if (nameController.text.isEmpty) {
            snack(context, "Please! Enter Skill Name");
          } else if (levelController.text.isEmpty) {
            snack(context, "Please! Enter Level");
          } else {
            var data = {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                        ...
                        InkWell(
                          onTap: () async{
                            if (selectedData.isEmpty) {
                              snack(context, "Please Enter Skills");
                            } else {
                              await setSkills();
                              Navigator.push(
                                  context,
                  ...
                  DataTable(columns: [
                    DataColumn(label: Text("Skill Name")),
