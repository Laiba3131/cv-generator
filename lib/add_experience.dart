...
class _AddExperienceState extends State<AddExperience> {
  ...
  setAddExperience() async {
    ...
    pref.setString(EXPERIENCE, jsonEncode(selectedData));
  }
              ...
              child: Column(
                ...
                children: [
                        ...
                        InkWell(
                          onTap: ()async {
                            if (selectedData.isEmpty) {
                              snack(context, 'Please Enter Experience Data');
                            } else {
                             await setAddExperience();
                              Navigator.push(
                                  context,
                                  CupertinoPageRoute(
                                      builder: (context) => Cv()));
                  ...
                  DataTable(columns: [
                    ...
                    DataRow(cells: [
                      DataCell(Text(data["nCompany"])),
                      DataCell(Text(data["designation"])),
                      DataCell(Text(data["description"])),
                      DataCell(Text(data["jobRole"])),
